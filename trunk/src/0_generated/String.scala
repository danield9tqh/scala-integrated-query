...
trait IStringOps extends IModuleBase{
  ...
  def infix_>( x: Rep[String], y: Rep[String] )(implicit module_num: Overloaded2): Rep[Boolean]
  def infix_+( x: Rep[String], y: Rep[AnyVal] )(implicit module_num: Overloaded2, overload: Overloaded3): Rep[String]
  def infix_+( x: Rep[AnyVal], y: Rep[String] )(implicit module_num: Overloaded2, overload: Overloaded4): Rep[String]
  def infix_+( x: Rep[String], y: Rep[String] )(implicit module_num: Overloaded2, overload: Overloaded5): Rep[String]
}
trait StringOps extends ModuleBase with IStringOps{
  ...
  def infix_>( x: Exp[String], y: Exp[String] )(implicit module_num: Overloaded2) = ( `>(String,String)`(x,y) ) // apply transform() here
  def infix_+( x: Exp[String], y: Exp[AnyVal] )(implicit module_num: Overloaded2, overload: Overloaded3) = ( `+(String,AnyVal)`(x,y) ) // apply transform() here
  def infix_+( x: Exp[AnyVal], y: Exp[String] )(implicit module_num: Overloaded2, overload: Overloaded4) = ( `+(AnyVal,String)`(x,y) ) // apply transform() here
  def infix_+( x: Exp[String], y: Exp[String] )(implicit module_num: Overloaded2, overload: Overloaded5) = ( `+(String,String)`(x,y) ) // apply transform() here
